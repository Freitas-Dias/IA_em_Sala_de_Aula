...
Este repositório guarda exemplos de como usar Inteligência Artificial para ajudar professores a planejar aulas, produzir materiais, criar atividades, adaptar atividades a dois perfis de alunos e avaliar alunos, de forma correta e responsável. Ideal para treinar decisões e fluência em IA educativa
...
- Título, descrição do desafio, resumo do plano, ferramentas de IA, links externos, reflexão final e créditos.
...
- **Diferenciação/Adaptações:**  
  - [estratégias para atender perfis distintos]  
...
**Dica:** mantenha prompts reutilizáveis em um `.docx` ou `.txt` (ex.: “Estrutura de objetivos”, “Adaptar para perfil visual”, “Reescrever em linguagem simples”, “Gerar slides-resumo por seção”).
